...
export type LeadProfile = { intent: SalesIntent; preferredAreas: string[]; propertyTypes: string[]; preferences: string[]; concerns: string[]; customFields: Record<string, string>; budget?: string; timeline?: string; bedrooms?: string; consentToFollowUp: boolean | null }
