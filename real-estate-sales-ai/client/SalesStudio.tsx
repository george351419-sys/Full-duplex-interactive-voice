...
import { DEFAULT_MODULE, SYSTEM_MODULES, type ConversationModule } from './modules'
...
export function SalesStudio() {
  ...
  function persist(lead: LeadRecord, completion?: VoiceCompletion) { setRecords(saveConversationRecord({ lead, module, completion })) }
  ...
  return <main className="sales-studio">
    ...
    {tab === 'modules' && <ModuleConfigPanel modules={SYSTEM_MODULES} selected={module} onSelect={selectModule} onToggleField={toggleField} />}
    {tab === 'records' && <ConversationRecordsPanel records={records} />}
  </main>
}
